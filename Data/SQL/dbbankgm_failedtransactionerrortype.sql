...
CREATE TABLE `failedtransactionerrortype` (
  `FailedTransactionErrorTypeID` tinyint unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `failedtransactionerrortype` VALUES (1,'Withdraw limit reached'),(2,'Daily limit reached'),(3,'Insufficient balance'),(4,'Invalid denomination'),(5,'ATM machine down');
...
-- Dump completed on 2023-07-16 13:42:32
