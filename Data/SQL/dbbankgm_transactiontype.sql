...
CREATE TABLE `transactiontype` (
  `TransactionTypeID` tinyint unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `transactiontype` VALUES (1,'Deposit','Deposit money',0.00),(2,'Withdrawal','Withdraw money',2.50),(3,'Transfer','Transfer money',1.00),(4,'Payment','Make a payment',0.50),(5,'Balance','Check balance',0.00);
